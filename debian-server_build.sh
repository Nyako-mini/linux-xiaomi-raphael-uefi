...
# 安装基础软件包
chroot rootdir apt install -y bash-completion sudo apt-utils ssh openssh-server nano network-manager chrony curl wget locales tzdata fonts-wqy-microhei dnsmasq iptables iproute2
